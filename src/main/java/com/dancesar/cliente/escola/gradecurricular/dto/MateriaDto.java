package com.dancesar.cliente.escola.gradecurricular.dto;
...
public class MateriaDto {
    ...
    @Min(value = 34, message = "Permitido o mínimo de 34 hor por matéria.")
    @Max(value = 120, message = "Permitido o máximo de 20 horas por matéria.")
